...
class CreateNewUserActivity : AppCompatActivity() {
    ...
    private fun createUser(user_id: String?){
        ...
        lHeaderMap["Accept"] = "application/json"
        lHeaderMap["Content-Type"] = "application/json"
        lHeaderMap["Authorization"] = "Bearer ${Constants.ACCESS_TOKEN}"
        if(user_id == null)
            viewModel.createUser(lHeaderMap,user)
        else
